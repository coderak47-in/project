  ...
  class home extends JFrame implements ActionListener
{
	...
	Container c;
	 static int in=0,i=0,t=0;
	 int pr[]=new int[15];
	 static String pe="admin";
	  home()
	{
		//super("Billing Projects ");
		this.c = getContentPane();
		 c.setBackground(new Color(255,179,179));
		c.setLayout(null); 
		c.setBounds(0,0,850,590);
		/*if(pe.equals("other"))
		{
    ...
    //public void nn(String p,String un,String pa,String id)
    public static void main(String... s)
 	{
		...
		/*if(pe.equals("other"))
		{
			try
			{
				...
				t=0;in=0;
				ResultSet rs = stm.executeQuery("select * from perm where id='10'");
				while(rs.next())
				{	
					t=1;	
